...
public class PushyWorld extends World {
    ...
    private static void setDelegate() {
        try {
            ...
            GreenfootUtilDelegate newDelegate = new GreenfootUtilDelegate() {
                @Override
                public URL getResource(String s) {
                    System.out.println(s);
                    URL url = Main.class.getClassLoader().getResource(s);
                ...
                @Override
                public GreenfootImage getUserImage(String s) {
                    return delegate.getUserImage(s);
                }
            ...
            delegateField.set(null, newDelegate);
